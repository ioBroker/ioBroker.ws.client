 ...
 * v 2.1.0 (2025_06_21)
 */
Object.defineProperty(exports, "__esModule", { value: true }), exports.SocketClient = void 0, void 0 !== globalThis.process && (globalThis.location ||= { href: "http://localhost:8081/", protocol: "http:", host: "localhost:8081", pathname: "/", hostname: "localhost", reload: /* @__PURE__ */ __name(() => {
}, "reload") });
  ...
  connect(url, options) {
    ...
    try {
      if ("/" === this.url) {
        ...
        (window.location.pathname.endsWith(".html") || window.location.pathname.endsWith(".htm")) && parts.pop(), this.url = `${globalThis.location?.protocol || "http:"}//${globalThis.location?.host || "localhost"}/${parts.join("/")}`;
      }
...
exports.SocketClient = SocketClient, globalThis.io = { connect };
